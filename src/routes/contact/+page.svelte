...
<div in:fade={{ duration: 800 }} class="py-12 container mx-auto px-4 sm:px-6 lg:px-8 relative z-0">
    ...
    <h1 class="text-5xl font-bold mb-4 text-center text-primary" in:fly={{ y: -30, duration: 800, delay: 300 }}>Contact Me</h1>
    ...
    <div class="grid md:grid-cols-2 gap-8 mb-12">
        <AnimateInView type="fade" delay={300}>
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 h-full transform transition-all duration-500 hover:shadow-md">
                ...
                <a href="mailto:contact@fatihnayebi.com" 
                   class="text-primary hover:underline flex items-center group mb-8 text-lg">
                ...
                <div class="flex flex-col space-y-4">
                    <a href="https://linkedin.com/in/fatihnayebi" target="_blank" rel="noopener noreferrer" 
                       class="flex items-center bg-blue-50 text-blue-700 p-3 rounded-lg hover:bg-blue-100 transition-colors group">
                    ...
                    <a href="https://twitter.com/fatihnayebi" target="_blank" rel="noopener noreferrer" 
                       class="flex items-center bg-blue-50 text-blue-500 p-3 rounded-lg hover:bg-blue-100 transition-colors group">
                        <svg class="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <a href="https://github.com/fatihnayebi" target="_blank" rel="noopener noreferrer" 
                       class="flex items-center bg-gray-50 text-gray-700 p-3 rounded-lg hover:bg-gray-100 transition-colors group">
                        <svg class="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <AnimateInView type="fly" x={20} delay={500}>
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-500 hover:shadow-md">
                ...
                {#if isSubmitted}
                    <div in:scale class="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                        ...
                        <p class="text-green-700">Thank you for your message. I'll get back to you as soon as possible.</p>
                        <button 
                ...
                {:else}
                    <form class="space-y-6" on:submit|preventDefault={handleSubmit}>
                        ...
                        <button type="submit" 
                            class="w-full bg-primary text-white font-medium py-3 px-4 rounded-lg hover:bg-primary/90 transition-colors flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
