<script>
    ...
    const pageTitle = "Retail AI & Agentic Systems Blog | Dr. Fatih Nayebi";
    const pageDescription = "Insights and analysis on AI for Retail, Agentic AI systems, machine learning applications, inventory optimization, and retail technology innovation.";
    const keywords = "Retail AI blog, Agentic AI insights, inventory optimization, AI ethics, retail machine learning, assortment planning, Fatih Nayebi";
    ...
    const openGraphData = {
      ...
      url: canonicalUrl,
      image: `${siteUrl}/images/social-card.jpg` // Use default social card
    };
    ...
    // Structured data is generated by getBlogListSchema
    const structuredData = (blogPosts && blogPosts.length > 0) ? getBlogListSchema() : null;

    // Specific breadcrumb for the /blog page - now handled directly in the page
    // const blogPageBreadcrumb = {/* ... */}; - No longer needed
</script>

<svelte:head>
  <!-- Hardcoded breadcrumb for Blog page -->
...
<PageContainer heroSection={true}>
    ...
    <div class="mb-8">
        <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <span class="text-gray-800 dark:text-gray-300">Blog</span>
        </div>
    </div>
